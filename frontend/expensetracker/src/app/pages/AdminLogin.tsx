            ...
            <div className="auth-header">
              <div className="logo-compact">
                <svg width="48" height="48" viewBox="0 0 40 40" fill="none">
                  <rect width="40" height="40" rx="8" fill="url(#gradient-admin-login)" />
                  <path d="M20 10L28 20L20 30L12 20L20 10Z" fill="white" opacity="0.9" />
                  <defs>
                    <linearGradient id="gradient-admin-login" x1="0" y1="0" x2="40" y2="40">
              ...
              <p className="auth-subtitle">Sign in to access the admin console</p>
            </div>
            ...
            <div className="benefit-list">
              <div className="benefit-item">
                <div className="benefit-icon">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                    <path d="M10 2L3 5V9C3 13.4183 5.68629 17.4183 10 19C14.3137 17.4183 17 13.4183 17 9V5L10 2Z" stroke="white" strokeWidth="1.5" />
                    <path d="M7.5 9.5L9 11L12.5 7.5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              ...
              <div className="benefit-item">
                <div className="benefit-icon">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                    <path d="M4 9L8 13L16 5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
                <div className="benefit-content">
                  <h4>Real-Time Analytics</h4>
                  <p>Live data from the database — users, expenses, categories, trends.</p>
                </div>
              </div>
              <div className="benefit-item">
                <div className="benefit-icon">
                ...
                <div className="benefit-content">
                  ...
                  <p>Track server status, DB connection and API request counts.</p>
                </div>
              </div>
            </div>
          </div>
